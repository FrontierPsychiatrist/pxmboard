...
class cActionBoard extends cAction{
	...
	function performAction(){
		...
		if($this->m_objConfig->getActiveBoard()){
			$this->m_objTemplate = &$this->_getTemplateObject("board");
			$this->m_objTemplate->addData($this->m_objConfig->getDataArray(array("thrdid"	=> $this->m_objInputHandler->getIntFormVar("thrdid",TRUE,TRUE,TRUE),
