...
class cAdminActionBadwordform extends cAdminAction{
	...
	function performAction(){
		...
		if($objActiveUser = &$this->m_objConfig->getActiveUser() && $objActiveUser->isAdmin()){
			...
			$this->m_sOutput .= "<input type=\"hidden\" name=\"mode\" value=\"admbadwordsave\"><table border=\"1\" id=\"c\">\n";
			$this->m_sOutput .= "<tr><td colspan=\"2\" id=\"h\">badwords</td></tr>\n";
			$this->m_sOutput .= "<tr valign=\"top\"><td>badword=>replacement<br>badword2=>replacement2</td><td><textarea cols=\"30\" rows=\"30\" name=\"badword\">";
