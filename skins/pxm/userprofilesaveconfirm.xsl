...
<tr class="bg2">
	<td align="center" id="norm">profile von <a href="pxmboard.php?mode=userprofile&amp;usrid={config/user/id}{config/sid}"><xsl:value-of select="config/user/nickname"/></a></td>
</tr>
<tr class="bg1">
