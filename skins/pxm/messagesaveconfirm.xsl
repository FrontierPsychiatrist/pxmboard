...
<tr class="bg2">
	<td id="norm">vielen dank für ihre nachricht &quot;<a href="pxmboard.php?mode=message&amp;brdid={config/board/id}&amp;msgid={msg/id}{config/sid}"><xsl:value-of select="msg/subject"/></a>&quot;</td>
</tr>
<tr class="bg2">
