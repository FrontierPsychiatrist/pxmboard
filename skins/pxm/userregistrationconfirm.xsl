...
<tr class="bg2">
	<td id="norm">sie sind nun als <xsl:value-of select="user/nickname"/> angemeldet.</td>
</tr>
<tr class="bg2">
	<td id="norm">ihr passwort wurde an <xsl:value-of select="user/email"/> geschickt.</td>
</tr>
<tr class="bg1">
